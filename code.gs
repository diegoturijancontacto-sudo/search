...
* ESTRUCTURA REGISTROS OBRA (Ficha técnica) - ACTUALIZADA con medidas:
...
// Índices de columnas (1-based) en hoja RegistrosObra (ACTUALIZADO con medidas)
...
// RegistrosObra (ACTUALIZADO con medidas)
...
// REGISTROS OBRA / FICHA TÉCNICA (CRUD) + autor/provenance/clave + MEDIDAS
